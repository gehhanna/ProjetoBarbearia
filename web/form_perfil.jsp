...
<html>
    ...
    <body class="div">
        ...
        <section>
            <div id="bar_top">
                <div id="titulo">
                    <p class="fs-1 bi bi-scissors"> Cadastrar perfil
                ...
                <div id="tables">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            <label for="nome" style="border-radius: 30px; background-color:#251631; width: 130px; text-align: center;" class="textos">Nome Perfil</label>
                            </br>
                            <input type="text" style="border-radius: 30px" class="form-control fs-4 nome"  name="nome" required="" value="${perfil.nome}" maxlength="45"/>
                        </div>
                    </div>
                    <div>
                        <button class="btn btn-success fs-4">Gravar</button>
                        <a href="listar_perfil.jsp" class="btn btn-warning fs-4">Voltar</a>
                    </div>
